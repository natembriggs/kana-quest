...
Status: **in progress** — phases 0-6, 3a and 3b done (see §12's phase table).
...
detail screen, and per-mode study toggles), and a Higher tier for the
frequency-fallback data (own unit per theme, browsed as one "Common words 2"
group) are all live behind the fourth "Vocabulary" script on the home
screen. Not yet built: A level (phase 7) and stories.
