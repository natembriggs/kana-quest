...
const workerEvents = {};
const cacheNames = ['kana-quest-old', 'kana-quest-2026-08-22b', 'other-app-v4'];
const deletedCaches = [];
...
check('activation retains the current Kana Quest cache', !deletedCaches.includes('kana-quest-2026-08-22b'));
