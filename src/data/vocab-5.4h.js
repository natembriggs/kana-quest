...
export const VOCAB_ENTRIES = [
  ...
  },
  {
    ...
    "ex": [
      ...
      {
        "j": "ラグビーの試合の後、全身打ち身だらけだった。",
        "en": "My whole body was one big bruise after the rugby game.",
        "r": [
          [5, 1, "し"],
          [6, 1, "あい"],
          [8, 1, "あと"],
      ...
      {
        "j": "全身が焼き尽くされるような感じがした。",
        "en": "I felt a burning sensation all over.",
        "r": [
          [0, 1, "ぜん"],
          [1, 1, "しん"],
          [3, 1, "や"],
  ...
  },
  {
    ...
    "ex": [
      ...
      {
        "j": "私は胃に激しい痛みを覚えた。",
        "en": "I felt a sharp pain in the stomach.",
        "r": [
          [0, 1, "わたし"],
          [2, 1, "い"],
          [4, 1, "はげ"],
  ...
  },
  {
    ...
    "ex": [
      ...
      {
        "j": "先生は私の背中をぽんとたたいた。",
        "en": "The teacher patted me on the back.",
        "r": [
          [0, 1, "せん"],
          [1, 1, "せい"],
          [3, 1, "わたし"],
  ...
  },
  {
    ...
    "ex": [
      ...
      {
        "j": "風邪には睡眠が最良の薬です。",
        "en": "Sleep is the best medicine for a cold.",
        "r": [
          [0, 2, "かぜ"],
          [4, 1, "すい"],
          [5, 1, "みん"],
