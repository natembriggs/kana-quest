...
export const CHANGELOG = [
  {
    ...
    changes: [
      ...
      'New: a quiz question now offers "Exit and save progress" above the highlighted Next button, right from the first question — tapping it shows the same tappable end-of-session summary a finished session would, instead of silently dropping back to the course screen. Nothing about how progress is saved has actually changed (every answer was already saved the moment it was graded); this just makes that visible.',
