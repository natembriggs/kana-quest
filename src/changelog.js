...
export const CHANGELOG = [
  {
    date: '2026-09-03',
    changes: [
      'Changed: characters or words you keep getting wrong now come back for review sooner after you finally get them right, instead of jumping straight back to a long gap. Two misses in a row and the next few correct answers only earn a short interval each, until you\'ve actually proven it a few times running — then it climbs back to normal.',
