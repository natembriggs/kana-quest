...
export const STORY_SOURCES = chapters.map((body, index) => expandStory({
  ...
  source: {
    ...
    by: 'Claude Opus 5',
    credit: 'Written by',
    illustrations: index === 0 ? 'Inline painting generated with OpenAI image generation, using the chapter cover as a character and palette reference.' : undefined,
  ...
  art: index === 0 ? { inline: [{ after: 1, file: '01.webp' }] } : undefined,
  lexicon: definitions,
